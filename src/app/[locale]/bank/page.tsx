...
function page() {
  ...
  return (
    ...
    <div className="mt-6 mx-4 px-6 relative overflow-x-auto shadow-md sm:rounded-lg">
      ...
      <p className='text-xl px-4 mb-4'>Choose the name of the person you want to confirm and click (confirm) to see their details.</p>
          ...
          <tbody>
            ...
            {dataList.map((item, index) => (
              <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="py-4">
                  <Link href={"/" + locale + "/bank/infopers"}>
